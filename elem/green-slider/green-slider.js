var greenSliderCircle = document.getElementById('green-slider__circle');
var greenSlider = document.getElementById('green-slider');
var greenSliderBarActive = document.getElementById('green-slider__bar_active');
var greenSliderNumb2 = document.getElementById('green-slider__number_2');
var greenSliderNumb3 = document.getElementById('green-slider__number_3');
var greenSliderNumb4 = document.getElementById('green-slider__number_4');
var greenSliderNumb5 = document.getElementById('green-slider__number_5');
greenSliderCircle.onmousedown = function(ev) {
    var circleCoords = getCoords(greenSliderCircle);
    var shiftX = ev.pageX - circleCoords.left;
    var sliderCoords = getCoords(greenSlider);
    document.onmousemove = function(ev) {
        var newLeft = ev.pageX - shiftX - sliderCoords.left;
        if ( newLeft < 0 ) {
            newLeft = 0;
        }
        var rightEdge = greenSlider.offsetWidth - greenSliderCircle.offsetWidth;
